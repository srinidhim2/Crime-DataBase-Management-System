...
<body>
  <?php session_start(); ?>
<form  action="victimcon.php" method="post">

  <div class="container">
  <center>  <h1> Victim Registeration Form</h1> </center>
  <hr>
<div>
  <label>
    Name
...
Phone No:
  ...
  <div>
    Complaint Id :
        <input type="text" placeholder="Victim Complaint Id" value="<?=$_SESSION['comp_id']?>" name="vcid">
  </div>
