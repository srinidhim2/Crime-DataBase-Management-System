...
.button1:active {
  ...
  <body>
    ...
    $res1 = mysqli_query($con,"select * from complaint WHERE p_id=$n and cleared=0");
    $num1 = mysqli_num_rows($res1);
    $res2 = mysqli_query($con,"select * from complaint WHERE p_id=$n and cleared=01");
    $num2 = mysqli_num_rows($res2);
    $res3 = mysqli_query($con,"select * from complaint");
