...
session_start();
   ...
   $result = mysqli_query($con,"SELECT * FROM u_login");
   ...
   while($row = mysqli_fetch_array($result)) {
      ...
      echo "
        ...
        <form action='delete.php' method='get'>
          <a href='delete.php'><button class='button1' name='status' value=".$row['u_id'].">Delete</button></a>
        </form>
      </td>"
      ;
   //
   ...
   // mysqli_close($con);
?>
  <td><img src="../uploads/<?php echo $row['file_name'] ?>" width="350px" height="250px" />
</td></tr>
<?php } ?>
</table>
